...
async def handle_buttons(callback_query: CallbackQuery):
    ...
    if callback_query.data == "back":
        ...
        sent_message = await callback_query.message.answer("Введите ваш текст, и я сохраню его для последующего отображения на браслете:", reply_markup=BACK_BUTTON)
        user_states[user_id] = "add_text"

    elif callback_query.data == "show_saved_text":
        asyncio.create_task(send_saved_text(user_id))
